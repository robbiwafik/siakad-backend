...
class StaffProdi(models.Model):
    ...
    temp_program_studi = models.ForeignKey(TempProgramStudi, on_delete=models.CASCADE, null=True) # add related_name and set null = false later
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
...
class Dosen(models.Model):
    ...
    temp_program_studi = models.ForeignKey(TempProgramStudi, on_delete=models.PROTECT, null=True) # set null=false later
...
class Kelas(models.Model):
    ...
    temp_program_studi = models.ForeignKey(TempProgramStudi, on_delete=models.PROTECT, null=True) # add related_name and set null = false later
...
class KaryaIlmiah(models.Model):
    ...
    temp_program_studi = models.ForeignKey(TempProgramStudi, on_delete=models.SET_NULL, null=True) # add related_name later
